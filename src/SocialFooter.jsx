        ...
        <div className="social-share">
          ...
          >
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path d="M23.95 4.57c-.89.39-1.83.65-2.83.77a4.93 4.93 0 0 0 2.17-2.72 9.86 9.86 0 0 1-3.13 1.2A4.92 4.92 0 0 0 11.64 7.2 13.97 13.97 0 0 1 1.49 2.05a4.92 4.92 0 0 0 1.52 6.57 4.9 4.9 0 0 1-2.23-.62v.06a4.93 4.93 0 0 0 3.95 4.83 4.95 4.95 0 0 1-2.22.08 4.93 4.93 0 0 0 4.6 3.42A9.88 9.88 0 0 1 1 18.49c-.4 0-.79-.02-1.18-.07A13.94 13.94 0 0 0 7.55 20.7c9.14 0 14.14-7.57 14.14-14.14v-.64a10.1 10.1 0 0 0 2.26-2.35z" />
            </svg>
          </a>
          ...
          <button
            ...
            title="Share Type Perfectly"
          >
            <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
              <path
                d="M14 5h5v5M19 5 10 14M19 13v6H5V5h6"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
